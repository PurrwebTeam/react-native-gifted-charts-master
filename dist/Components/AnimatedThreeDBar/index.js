...
import { useAnimatedThreeDBar, } from "gifted-charts-core/src";
...
var AnimatedThreeDBar = function (props) {
    ...
    return (_jsx(View, { style: styles.container, children: !initialRender && (_jsxs(View, { style: [
                ...
                props.side === "right" && { transform: [{ rotateY: "180deg" }] },
                                ...
                                top: sideWidth / -2,
                                left: barWidth - 1,
                            }, children: _jsx(TriangleCorner, { color: topColor, width: sideWidth, style: {
                                    transform: [{ rotate: "-90deg" }],
                                    opacity: opacity,
                                } }) })] })) : null, _jsxs(View, { style: { marginTop: sideWidth / -2 - 1 }, children: [_jsx(TriangleCorner, { color: height ? sideColor : "transparent", width: sideWidth, style: { transform: [{ rotate: "-90deg" }], opacity: opacity } }), _jsx(View, { style: {
                                width: sideWidth / 2 + 1,
