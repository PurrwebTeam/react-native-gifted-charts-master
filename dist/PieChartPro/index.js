...
import { pieColors, usePiePro, } from "gifted-charts-core/src";
...
export var PieChartPro = function (props) {
    ...
    if (!props.semiCircle &&
        data.some(function (dataItem) { return dataItem.value > total / 2; })) {
    ...
    return (_jsxs(View, { style: {
            ...
            width: height * 2,
                    ...
                    ], children: total ? (_jsxs(_Fragment, { children: [_jsx(Defs, { children: data.map(function (item, index) {
